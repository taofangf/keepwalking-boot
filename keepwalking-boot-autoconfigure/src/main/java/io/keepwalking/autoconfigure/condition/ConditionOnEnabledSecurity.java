...
import static io.keepwalking.autoconfigure.Constants.PROPERTY_NAME_PREFIX;
...
@Documented
@ConditionalOnProperty(prefix = PROPERTY_NAME_PREFIX, name = PROPERTY_NAME_ENABLED, matchIfMissing = true)
